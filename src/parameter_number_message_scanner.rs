...
/// use helgoboss_midi::{ParameterNumberMessage, ParameterNumberMessageScanner, ScanOutcome};
///
...
impl ParameterNumberMessageScanner {
    ...
    pub fn feed(&mut self, msg: &impl ShortMessage) -> ScanOutcome<ParameterNumberMessage> {
